...
const AlertDialogFooter = ({
  ...
  <div
    className={cn(
      "-mx-4 -mb-4 flex flex-col-reverse gap-2 rounded-b-xl border-t bg-muted/50 p-4 sm:flex-row sm:justify-end sm:space-x-2",
      className
    )}
    {...props}
  />
