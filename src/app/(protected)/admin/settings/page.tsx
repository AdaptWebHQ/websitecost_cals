        ...
        <Card className="bg-card border-border backdrop-blur-md rounded-2xl p-6 flex flex-col justify-between">
          <div>
            <CardHeader className="p-0 pb-3 flex flex-row items-center gap-3">
              ...
              <div>
                <CardTitle className="text-foreground text-base font-bold">Calculator Constants</CardTitle>
                <CardDescription className="text-muted-foreground text-xs">Configure markups and GST</CardDescription>
              </div>
            </CardHeader>
            <CardContent className="p-0 text-muted-foreground text-sm mt-2">
              Customize the default margins, pricing formulas, terms & conditions, and support details shown in quotations.
            </CardContent>
          </div>
          <div className="mt-6">
            <Link href="/admin/price-config">
        ...
        <Card className="bg-card border-border backdrop-blur-md rounded-2xl p-6 flex flex-col justify-between">
          <div>
            <CardHeader className="p-0 pb-3 flex flex-row items-center gap-3">
              ...
              <div>
                <CardTitle className="text-foreground text-base font-bold">Admin Permissions</CardTitle>
                <CardDescription className="text-muted-foreground text-xs">Manage system access roles</CardDescription>
              </div>
            </CardHeader>
            <CardContent className="p-0 text-muted-foreground text-sm mt-2">
          ...
          <div className="mt-6">
            <Button disabled variant="outline" className="border-border text-muted-foreground rounded-xl w-full">
