...
- text: ADAPTWEB
- heading "Get Everything You Want" [level=1]
- paragraph: You can get everything you want if you work hard, trust the process, and stick to the plan.
- img "Logo"
- heading "Welcome Back" [level=2]
- paragraph: Sign in with your Google account to continue to AdaptWeb
- button "Continue with Google":
  - img
  - text: Continue with Google
- img
- text: Secure sign-in, no password required New to AdaptWeb? Signing in with Google
